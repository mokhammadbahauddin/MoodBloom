  ...
  return (
    <div className="space-y-8 md:space-y-12 pt-2 md:pt-4 pb-20 relative min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        {/* Logger Column */}
        <div className={`${existingLog ? "lg:col-span-7" : "lg:col-span-12 max-w-4xl mx-auto w-full"} transition-all duration-1000 space-y-6 md:space-y-8`}>
              ...
              {selectedSleep !== null && selectedMood !== null && (
                ...
                >
                  ...
                  <div className="pt-4">
                    <Button
                      onClick={saveCheckIn}
                      className="w-full h-14 rounded-2xl text-xs uppercase tracking-widest bg-primary hover:bg-primary/95 text-white font-bold transition-all shadow-sm flex items-center justify-center gap-2"
                    >
                      <span>Check-in</span>
                      <Sparkles size={16} />
                    </Button>
